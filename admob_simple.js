...
if( /(android)/i.test(navigator.userAgent) ) {
  admobid = { // for Android
    banner: 'ca-app-pub-4893498225024488/8091867854',
    interstitial: 'ca-app-pub-4893498225024488/9568601056'
  };
} else if(/(ipod|iphone|ipad)/i.test(navigator.userAgent)) {
  admobid = { // for iOS
    banner: 'ca-app-pub-4893498225024488/3661668252',
    interstitial: 'ca-app-pub-4893498225024488/5138401450'
  };
} else {
